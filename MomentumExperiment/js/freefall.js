...
export class FreeFallTab {
    ...
    _switchMode(mode) {
        ...
        const ffCanvasContainer = $('freefall-canvas').parentElement;
        ffCanvasContainer.classList.toggle('sim-mode', mode === 'simultaneous');
        ffCanvasContainer.parentElement.classList.toggle('sim-mode', mode === 'simultaneous');
